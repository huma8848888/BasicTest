...
//    fun insertAndGetUploadPage(id: String): UploadResultModel {
//        if (pagesUploadMap[id] == null) {
//            val page = UploadResultModel()
//            pagesUploadMap[id] = page
//            return page
//        } else {
//            return pagesUploadMap[id]!!
//        }
//    }
//
//    fun clearTraceAndUploadResult(id: String) {
//        writePages.remove(id)
//        pagesUploadMap.remove(id)
//    }
